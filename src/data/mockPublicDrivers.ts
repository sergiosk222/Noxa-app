...
export const publicDrivers: PublicDriver[] = [
  {
    ...
    garage: [
      ...
      {
        id: "midnight-fastback",
        name: "Midnight Fastback",
        image:
    ...
    activity: [
      {
        id: "night-run",
        label: "Joined Night Run",
        meta: "18 min ago",
        icon: "flag",
      },
      {
        id: "new-car",
        label: "Uploaded new car",
        meta: "Yesterday",
        icon: "car-sport",
      },
    ...
    achievements: [
      {
        id: "elite",
        title: "Elite Driver",
        subtitle: "4.9 reputation",
        icon: "star",
      },
      {
        id: "garage",
        title: "Curated Garage",
        subtitle: "3 verified builds",
        icon: "diamond",
      },
      {
        id: "crew",
        title: "Crew Loyalist",
        subtitle: "Midnight Society",
...
export const getPublicDriverById = (id?: string) =>
  publicDrivers.find((driver) => driver.id === id) ?? publicDrivers[0];
