...
const styles = StyleSheet.create({
  ...
  streetCenter: { height: 1, backgroundColor: colors.glass },
  ...
  parkingOne: { position: 'absolute', left: '10%', top: '52%', width: 72, height: 48, borderRadius: 12, borderWidth: 1, borderColor: colors.border, backgroundColor: 'rgba(255,255,255,0.028)', transform: [{ rotate: '-12deg' }] },
  parkingTwo: { position: 'absolute', right: '11%', top: '20%', width: 84, height: 52, borderRadius: 14, borderWidth: 1, borderColor: colors.border, backgroundColor: 'rgba(255,255,255,0.025)', transform: [{ rotate: '18deg' }] },
  ...
  eventCard: { position: 'absolute', left: spacing.lg, right: spacing.lg, bottom: 134, padding: spacing.lg, borderRadius: radius.card, borderWidth: 1, borderColor: 'rgba(255,255,255,0.11)', backgroundColor: colors.surface, shadowColor: '#000', shadowOpacity: 0.5, shadowRadius: 24, shadowOffset: { width: 0, height: 18 }, elevation: 18 },
  ...
  vehicleSection: { marginTop: spacing.lg, height: 152, overflow: 'hidden', borderRadius: 28, borderWidth: 1, borderColor: 'rgba(255,255,255,0.13)', backgroundColor: colors.background },
  ...
  statTile: { flex: 1, alignItems: 'center', paddingVertical: spacing.sm, borderRadius: 20, borderWidth: 1, borderColor: colors.border, backgroundColor: colors.glass },
